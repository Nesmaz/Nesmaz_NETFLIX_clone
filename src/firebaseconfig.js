...
const firebaseConfig = {
  ...
  projectId: process.env.REACT_APP_FIREEBASE_PRO_ID,
  storageBucket: process.env.REACT_APP_FIREEBASE_STORAGE_BUCKET,
  messagingSenderId: process.env.REACT_APP_FIREEBASE_MESSAGING_SENDER_ID,
  appId: process.env.REACT_APP_FIREEBASE_APP_ID,
  measurementId: process.env.REACT_APP_FIREEBASE_MEASUREMENT_ID
};
